    ...
    <section class="body">
		...
		<div class="inner-wrapper">
            ...
            <section role="main" class="content-body tab-menu-opened">
                ...
                <!-- start: page -->
                <section class="panel">
                    <form:form commandName="eduVO" name="eduVOForm" action="eduProgramManageEdit.do?key=${key}" method="post" onsubmit="return fn_submit(this)" enctype="multipart/form-data">
                    ...
                    <header class="panel-heading">
                        <div class="panel-actions">
                            <div class="mb-md">
                                <button type="submit" id="addToTable" class="btn btn-primary">수정 <i class="fa fa-plus"></i></button>
                            </div>
                        </div>
                        <h2 class="panel-title">프로그램 수정</h2>
                    </header>
                                ...
                                <div class="col-md-6">
                                    <div class="input-group color colorpicker-element" data-plugin-colorpicker="">
                                        <span class="input-group-addon"><i
                                                ...
                                                <form:input path="startGradation"  class="form-control"/>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group color colorpicker-element" data-plugin-colorpicker="">
                                        <span class="input-group-addon"><i
                                                style="background-color: rgb(25, 65, 92);"></i></span>
                                                <form:input path="endGradation"  class="form-control"/>
                                    </div>
                                </div>
                            </div>
                    </div>
